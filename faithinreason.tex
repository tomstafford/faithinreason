...
\note{\textcolor{red}{Draft 2023-04-27}}
...
(OSF pre-registration link: \url{https://osf.io/y9kjg/?view_only=609cd46aab534e4c866c16b3ef29c510}). Note that the bulk of this preregistration confirms the analyses reported in Zhu et al. (submitted).

Preregistration supports the correct marking of confirmatory versus exploratory analyses. The nature of scale development is exploratory, but the preregistration allows readers confirm what was intended before data was collected.
